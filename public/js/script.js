...
logout.addEventListener("click", () => {
  localStorage.setItem("userFirstName", JSON.stringify(empty));
  profileDetails.style.display = "none";
});

// profileDetails.style.display = "none";
// Active menu  button of home page JS

// var header = document.getElementById("myBtn");
// var bt = header.getElementsByClassName("fff");
// var btns = header.getElementsByClassName("mBtn");
// // console.log(btns);
...
// var buttons = document.querySelectorAll(".mBtn");
...
//   console.log("hhhhhh", buttons);
//   buttons.forEach(function (btn) {
//     console.log("hhhhhhjhkhjhg");
//     btn.classList.remove("activeBtn");
//   });
//   buttonToActivate.classList.add("activeBtn");
